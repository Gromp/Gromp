...
switch (_shop) do
{
	...
	case "reb_car":
	{
		...
		if(license_civ_rebel) then
		{
			...
			_return set[count _return,
			["O_Heli_Light_02_unarmed_F",4000000]];
			_return set[count _return,
			["I_Heli_Transport_02_F",8000000]];
			_return set[count _return,
			["B_Heli_Transport_01_camo_F",10000000]];
			_return set[count _return,["O_MRAP_02_F",3333334]]; //ifrit
		};
	};
...
//3.1.2 MIGRATION
            ...
            case "donator_shop":
            {
                    ...
                    if(__GETC__(life_donator) == 1) then
                    {
                            ...
                            _return set[count _return,["O_MRAP_02_F",3200000]]; //ifrit
                    };
                ...
                _return set[count _return,["B_Heli_Light_01_F",500000]];           
                        _return set[count _return,["O_Heli_Light_02_unarmed_F",2400000]];
                            _return set[count _return,["I_Heli_Transport_02_F",10000000]];
                            _return set[count _return,["O_MRAP_02_F",3066667]]; //ifrit
                    };
                    if(__GETC__(life_donator) == 3) then
                    {
                        ...
                        _return set[count _return,["I_Truck_02_covered_F",120000]];
                            ...
                            _return set[count _return,["O_MRAP_02_F",2933334]]; //ifrit
                    };
                    if(__GETC__(life_donator) == 4) then
                    {
                            ...
                            _return set[count _return,["I_Heli_Transport_02_F",8000000]];
                            _return set[count _return,["B_Heli_Transport_01_camo_F",8000000]];
                            _return set[count _return,["O_MRAP_02_F",2800000]]; //ifrit
                    };
                    if(__GETC__(life_donator) == 5) then
                    {
                        ...
                        _return set[count _return,["I_Truck_02_covered_F",100000]];
                            ...
                            _return set[count _return,["I_Heli_Transport_02_F",7500000]];
                            _return set[count _return,["B_Heli_Transport_01_camo_F",7500000]];
